...
$( document ).ready(function(){
  ...
  $('h1').on('click', function () {
    ...
    console.log('hello!')// 1. log to the console that you have clicked the button
...
$('.photographer').text(randomBackground)    // 2. using jquery, change the image url of the body background to the new one saved above
